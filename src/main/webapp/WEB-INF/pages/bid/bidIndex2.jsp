...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <script type="text/html" id="currentTableBar">
            <a class="layui-btn layui-btn-normal layui-btn-xs data-count-edit" lay-event="produce">排产</a>
        </script>
...
<script>
    ...
    layui.use(['form', 'table'], function () {
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            var data = obj.data;
            if (obj.event === 'produce') {  // 监听删除操作
                layer.confirm('确定排产么', function (index) {
                    //调用删除功能
                    produceBid(data.id,index);
                    layer.close(index);
                });
            }
        });
