...
<div class="layui-form layuimini-form">
  ...
  <div class="layui-form-item">
    <label class="layui-form-label required">产品类型</label>
    <div class="layui-input-block">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="pno" lay-verify="required" lay-reqtext="产品编号不能为空" placeholder="请输入产品编号" value="" class="layui-input">
      <tip>填写产品编号</tip>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="norms" placeholder="请输入产品规格" value="" class="layui-input">
      <tip>填写产品规格</tip>
    </div>
  </div>
