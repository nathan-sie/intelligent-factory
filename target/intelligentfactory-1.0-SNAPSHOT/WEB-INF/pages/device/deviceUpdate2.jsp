...
<div class="layui-form layuimini-form">
    ...
    <input type="hidden" name="dno"  value="${device.dno}" >
    <input type="hidden" name="norms"  value="${device.norms}" >
    <input type="hidden" name="intro"  value="${device.intro}" >
    <input type="hidden" name="status"  value="${device.status}" >
    <input type="hidden" name="rent"  value="${device.rent}" >
    <input type="hidden" name="f_name"  value="${device.f_name}" >
